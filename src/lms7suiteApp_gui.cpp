...
AppFrame_view::AppFrame_view( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	wxMenuItem* mnuCDCM6208;
	mnuCDCM6208 = new wxMenuItem( mnuModules, ID_MENUITEM_CDCM6208, wxString( wxT("CDCM6208") ) , wxEmptyString, wxITEM_NORMAL );
	mnuModules->Append( mnuCDCM6208 );
	...
	fileMenu->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( AppFrame_view::OnQuit ), this, menuFileQuit->GetId());
	mnuOptions->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( AppFrame_view::OnShowConnectionSettings ), this, mnuConnectionSettings->GetId());
	mnuOptions->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( AppFrame_view::OnChangeCacheSettings ), this, mnuCacheValues->GetId());
	mnuModules->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( AppFrame_view::OnShowFFTviewer ), this, mnuFFTviewer->GetId());
	mnuModules->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( AppFrame_view::OnShowADF4002 ), this, mnuADF4002->GetId());
	mnuModules->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( AppFrame_view::OnShowSi5351C ), this, mnuSi5351C->GetId());
	mnuModules->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( AppFrame_view::OnShowCDCM6208 ), this, mnuCDCM6208->GetId());
	mnuModules->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( AppFrame_view::OnShowPrograming ), this, mnuPrograming->GetId());
	mnuModules->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( AppFrame_view::OnShowFPGAcontrols ), this, mnuFPGAcontrols->GetId());
	mnuModules->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( AppFrame_view::OnShowDeviceInfo ), this, mnuDeviceInfo->GetId());
	mnuModules->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( AppFrame_view::OnShowAPICalls ), this, mnuAPIcalls->GetId());
	mnuModules->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( AppFrame_view::OnShowSPI ), this, mnuSPI->GetId());
	mnuModules->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( AppFrame_view::OnShowBoardControls ), this, mnuBoardControls->GetId());
	mnuModules->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( AppFrame_view::OnShowLimeRFE ), this, mnuLimeRFE->GetId());
	helpMenu->Bind(wxEVT_COMMAND_MENU_SELECTED, wxCommandEventHandler( AppFrame_view::OnAbout ), this, menuHelpAbout->GetId());
}
